...
TEST_F(LinkedListTest, AddElements) {
    list.add(10);
    list.add(20);
...
TEST_F(LinkedListTest, RemoveByIndex) {
    list.add(10);
    list.add(20);
...
TEST_F(LinkedListTest, RemoveByElement) {
    list.add(100);
    list.add(200);
...
TEST_F(LinkedListTest, ThrowsOutOfBounds) {
    list.add(10);
...
TEST_F(LinkedListTest, ToStringFormat) {
    list.add(1);
    list.add(2);
